                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="mb-0">Reseignez les intranches du client pour creer un compte.</p>
                                    </div>
                                    <div class="card-body">
                                        <div class="px-3">
                                            <form class="form" method="post"
                                                  action="{{isset($tranche)?route("tranche.update"):route("tranche.store")}}">
                                                @csrf
                                                <div class="form-body">
                                                    <h4 class="form-section">
                                                        <i class="icon-user"></i> Intranches Personnelles</h4>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="projectinput2">Formations</label>
